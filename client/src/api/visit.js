...
export const list = async (req) => {
    ...
    try {
        ...
        response = await axios.get(`/api/visit/resv/`, {
            headers: {
...
export const visitUpdate = async (req) => {
    ...
    try {
        ...
        response = await axios.put(`/api/visit/resv/`, data, {
            headers: {
                'content-type': 'application/json',
                'Authorization': `Bearer ${req.accessToken}`
            }
...
export const visitDelete = async (req) => {
    ...
    try {
        response = await axios.delete(`/api/visit/resv/`, {
            headers: {
                'content-type': 'application/json',
                'Authorization': `Bearer ${req.accessToken}`
            },
...
export const settingList = async (req) => {
    ...
    try {
        ...
        response = await axios.get(`/api/visit/setting/`, {
            headers: {
                'content-type': 'application/json',
                'Authorization': `Bearer ${req.accessToken}`
            },
...
export const settingRegist = async (req) => {
    ...
    try {
        ...
        response = await axios.post(`/api/visit/setting/`, data, {
            headers: {
                'content-type': 'application/json',
                'Authorization': `Bearer ${req.accessToken}`
            }
...
export const settingUpdate = async (req) => {
    ...
    try {
        ...
        response = await axios.put(`/api/visit/setting/`, data, {
            headers: {
                'content-type': 'application/json',
                'Authorization': `Bearer ${req.accessToken}`
            }
...
export const settingDelete = async (req) => {
    ...
    try {
        response = await axios.delete(`/api/visit/setting/`, {
            headers: {
                'content-type': 'application/json',
                'Authorization': `Bearer ${req.accessToken}`
            },
...
export const csvDownload = async (req) => {
    ...
    try {
        ...
        response = await axios.get(`/api/visit/resv/csvDownload/`, {
            headers: {
                'Authorization': `Bearer ${req.accessToken}`
            },
            params,
