          ...
          <div class="dialog-content">
            ...
            <table>
              ...
              <tr>
                <th>방문 인원</th>
                <td>
                  <select class="person-select" name="person" id="contract-person" v-model="datas.visitNum" :disabled="profile===1?true:false">
                    <option v-for="(num, idx) in 10" :key="idx" :value="num">{{'본인(' + num + '인)'}}</option>
                  </select>
                </td>
              </tr>
              <tr>
  ...
  export default {
    ...
    methods: {
      ...
      async updateInfo (e) {
        ...
        try {
          await CONTRACT.visitUpdate(reqParam)
        }
        catch (e) {
          console.error(e)
      ...
      async deleteInfo (e) {
        ...
        this.loadingInstance.show()
        try {
          await CONTRACT.visitDelete(reqParam)
        }
        catch (e) {
          console.error(e)
          await this.loadingInstance.close()
