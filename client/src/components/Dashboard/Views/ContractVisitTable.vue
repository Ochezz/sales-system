<template>
    <div class="row visit-reservation-detail-wrap">
      <VisitContractInfoModal :datas="INFO_DATA"></VisitContractInfoModal>
      <h4>계약자방문 예약 현황</h4>
      ...
      <div class="top-wrap">
        ...
        <div>
          ...
          <div class="btn-wrap">
            ...
            <button class="btn-control setting-btn"><router-link :to="{path:'/reservation/contract/manage'}">예약관리현황</router-link></button>
...
<script>
  import VisitContractInfoModal from '../Modal/VisitContractInfoModal.vue'
  ...
  export default {
    ...
    methods: {
      ...
      async infoShow (rowDatas) {
        ...
        try {
          await CONTRACT.visitList(reqParam).then(res => {
      ...
      async excelDown () {
        ...
        this.loadingInstance.show()
        try {
          await CONTRACT.csvDownload(reqParam)
        }
        catch (e) {
          console.error(e)
          await this.loadingInstance.close()
