<template>
    <div class="row visit-reservation-detail-wrap">
      <PaymentManageRegistModal></PaymentManageRegistModal>
      <PaymentManageInfoModal :datas="INFO_DATA"></PaymentManageInfoModal>
      <h4>중도금대출 및 옵션 계약방문 예약 관리 현황</h4>
      ...
      <div class="top-wrap">
        ...
        <div class="customer-search-wrap">
          ...
          <div class="btn-wrap">
            ...
            <button class="btn-control setting-btn"><router-link :to="{path:'/reservation/payment/visit'}">예약현황</router-link></button>
...
<script>
  import PaymentManageRegistModal from '../Modal/PaymentManageRegistModal.vue'
  import PaymentManageInfoModal from '../Modal/PaymentManageInfoModal.vue'
  ...
  export default {
    components: {
      PaymentManageRegistModal,
      PaymentManageInfoModal
    },
    data () {
      return {
        nowDate: '',
    ...
    methods: {
      ...
      async infoShow (rowDatas) {
        ...
        try {
          await PAYMENT.settingList(reqParam).then(res => {
